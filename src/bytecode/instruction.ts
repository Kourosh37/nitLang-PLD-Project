...
export type Instruction =
  ...
  | { readonly op: "DEFINE" | "LOAD" | "STORE"; readonly binding: number; readonly span: SourceSpan }
  ...
  | { readonly op: "ENTER_SCOPE" | "EXIT_SCOPE" | "POP" | "PRINT" | "HALT"; readonly span: SourceSpan };
