...
export interface ClassValue {
  ...
  readonly methods: ReadonlyMap<string, FunctionDeclaration>;
...
export interface ObjectValue {
  ...
  readonly fields: ReadonlyMap<string, Location>;
}
export interface BoundMethodValue {
  readonly kind: "bound-method";
  readonly method: FunctionDeclaration;
  readonly receiver: ObjectValue;
  readonly environment: Environment;
}
