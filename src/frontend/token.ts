...
export const keywords = [
  "let", "func", "return", "lambda", "if", "then", "else", "while", "do",
  "for", "in", "range", "and", "or", "not", "ref", "class", "extends",
  "this", "new", "try", "catch", "throw", "match", "int", "bool", "string",
  "void", "true", "false",
] as const;
...
export type TokenKind = KeywordKind | PunctuationKind | "identifier" | "integer" | "string-literal" | "eof";
