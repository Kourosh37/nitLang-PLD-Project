...
export type TypeAnnotation =
  ...
  | (Node & { readonly kind: "FunctionType"; readonly parameters: readonly TypeAnnotation[]; readonly result: TypeAnnotation });
...
export type Statement =
  ...
  | (Node & { readonly kind: "LetDeclaration"; readonly name: Identifier; readonly annotation: TypeAnnotation | null; readonly initializer: Expression })
  ...
  | (Node & { readonly kind: "ForStatement"; readonly variable: Identifier; readonly start: Expression; readonly end: Expression; readonly body: BlockStatement })
