...
export type Expression =
  ...
  | (Node & {
      ...
      readonly operator: PrimitiveBinaryOperator;
  ...
  | (Node & {
      ...
      readonly parameters: readonly Surface.Parameter[];
...
export interface MatchArm extends Node {
  ...
  readonly pattern: Surface.Pattern;
...
export interface FunctionDeclaration extends Omit<Surface.FunctionDeclaration, "body"> {
  readonly body: BlockStatement;
}
export interface ClassDeclaration extends Omit<Surface.ClassDeclaration, "members"> {
  readonly members: readonly (Surface.FieldDeclaration | FunctionDeclaration)[];
}
export type Statement =
  ...
  | (Node & {
      ...
      readonly annotation: Surface.TypeAnnotation | null;
